...
public class ApplicationTestRunner extends RobolectricTestRunner {
  ...
  private static final String ANDROID_MANIFEST_PATH = "../gandalf-library/src/main/AndroidManifest.xml";
  private static final String ANDROID_MANIFEST_RES_PATH = "../gandalf-library/src/main/res";
